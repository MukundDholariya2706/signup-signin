  ...
  return (
    <>
      <div>
        ...
        {label && (
          <label
            className={`flex mb-2 text-sm font-medium text-black ${lableClassName}`}
          >
            {label}
          </label>
        )}
        ...
        <div className={`relative ${containerClassName}`}>
          ...
          <input
            ...
            className={`${prefix ? "ps-10" : ""} ${
              suffix ? "pe-10" : ""
            } block w-full p-2.5 text-sm text-gray-900 border 
        ...
        {error && (
          <p
            className={`flex mt-1 text-sm text-red-600 dark:text-red-500 ${erorrClassName}`}
          >
            {error}
          </p>
        )}
